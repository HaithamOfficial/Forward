...
### Deploy Now:
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/haithamwaheed/Forward)

### Host Locally:
```sh
git clone https://github.com/haithamwaheed/Forward
cd Forward-Client
